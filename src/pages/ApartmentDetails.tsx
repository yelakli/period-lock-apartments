          ...
          <div>
            <Card>
              <CardContent className="pt-6">
                ...
                <div className="flex items-baseline justify-between mb-4">
                  <div className="text-sm text-warning-500">N.B : Le prix de la nuitée peut varier selon la période de réservation. Voir la description de l'appartement pour plus de détail.</div>
                </div>
